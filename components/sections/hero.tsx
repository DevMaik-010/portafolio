      ...
      <div className="relative z-10 container px-4 md:px-8 py-20">
        <div className="max-w-4xl mx-auto text-center space-y-8 animate-slide-in-up">
          ...
          <div className="space-y-4">
            <h1 className="text-5xl md:text-7xl font-bold tracking-tight">DevSecOps Engineer</h1>
          ...
          <div className="flex flex-wrap gap-4 justify-center pt-4">
            <Button className="bg-primary text-primary-foreground hover:bg-primary/90 gap-2 px-6 py-6 text-base">
              <Github className="w-5 h-5" />
              GitHub
            </Button>
            <Button
              variant="outline"
              className="border-primary/50 text-primary hover:bg-primary/10 gap-2 px-6 py-6 text-base bg-transparent"
            >
            ...
            <Button
              variant="outline"
              className="border-secondary/50 text-secondary hover:bg-secondary/10 gap-2 px-6 py-6 text-base bg-transparent"
            >
